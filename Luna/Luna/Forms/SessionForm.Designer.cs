namespace Luna {
	partial class SessionForm {
		...
		private void InitializeComponent() {
			...
			this.DitherComboBox = new System.Windows.Forms.ComboBox();
			...
			label6.Location = new System.Drawing.Point(12, 124);
			label6.Name = "label6";
			label6.Size = new System.Drawing.Size(49, 13);
			label6.TabIndex = 2;
			label6.Text = "Dithering";
			// 
			// label2
			// 
			...
			this.SettingsTab.Controls.Add(label6);
			this.SettingsTab.Controls.Add(this.DitherComboBox);
			...
			this.GammaSlider.Location = new System.Drawing.Point(89, 148);
			...
			// DitherComboBox
			// 
			this.DitherComboBox.DisplayMember = "1";
			this.DitherComboBox.FormattingEnabled = true;
			this.DitherComboBox.Items.AddRange(new object[] {
            "Wyłączony",
            "2",
            "4",
            "6",
            "8"});
			this.DitherComboBox.Location = new System.Drawing.Point(89, 121);
			this.DitherComboBox.Name = "DitherComboBox";
			this.DitherComboBox.Size = new System.Drawing.Size(136, 21);
			this.DitherComboBox.TabIndex = 1;
			this.DitherComboBox.Tag = "";
			this.DitherComboBox.SelectedIndexChanged += new System.EventHandler(this.DitherComboBox_SelectedIndexChanged);
			// 
			// LightingTab
			// 
		...
		private System.Windows.Forms.ComboBox DitherComboBox;
